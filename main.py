...
class EmployeeManager:
    def run(self, old_file:str, new_file:str):
        ...
        not_found_departed, to_delete = self.check_if_in_teams(self.employees_to_delete, teams)
        not_found_new, in_teams = self.check_if_in_teams(self.employees_to_add, teams)
    ...
    #Change this to use ids instead of names, should cut down on categories
    def check_if_in_teams(self, employees:dict, teams_ids:list):
        not_found = []
        #check_manually = []
        to_change = []
        ...
        for employee in employees:
            if employee["Net ID"] in teams_ids:
